 	...
 	<div class="nav">
 		<div class="container">
 			...
 			<ul class="pull-right">
 				...
 				<li><form action="signout.php" method="post"><input type="submit" class="btn btn-primary" value="Sign out" style="display:inline-block;position:relative;float:right;"></form></li>
 			</ul>
 		</div>
 	</div>
